                    ...
                    <div class="col-12 h-100">
                        <div class="header-content h-100 d-flex align-items-center justify-content-between">
                              ...
                              <form>
                                <div class="inner-form">
                                  ...
                                  <div class="input-field second-wrap">
                                    <button class="btn-search h-100" type="button">SEARCH</button>
                                  </div>
                                </div>
                              </form>
                            </div>
                            ...
                            <!-- <div class="login-content">
                                <a href="#">Register &nbsp&nbsp&nbsp&nbsp&nbsp</a>
                                <a href="#">Login</a> -->
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h4 id="h4" data-animation="fadeInUp" data-delay="100ms">All the courses you need</h4>
                                <h2 id="h2" data-animation="fadeInUp" data-delay="400ms">Wellcome to our <br>Online University</h2>
                                <a id="readmore" href="#" class="btn academy-btn" data-animation="fadeInUp" data-delay="700ms">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="single-top-features d-flex align-items-center justify-content-center">
                                    ...
                                    <h5><a style="font-size: 18px;text-decoration: none; color: white;" href="">Online Courses</a></h5>
                                </div>
                            </div>
                            <!-- Single Top Features -->
                            <div class="col-12 col-md-4">
                                <div class="single-top-features d-flex align-items-center justify-content-center">
                                    ...
                                    <h5><a style="font-size: 18px;text-decoration: none; color: white;" href="">Amazing Teachers</a></h5>
                                </div>
                            </div>
                            <!-- Single Top Features -->
                            <div class="col-12 col-md-4">
                                <div class="single-top-features d-flex align-items-center justify-content-center">
                                    ...
                                    <h5><a style="font-size: 18px;text-decoration: none; color: white;" href="">Great Support</a></h5>
                                </div>
                            </div>
                        </div>
                    </div>
