...
<div style="margin-top: 50px" class="message-form container">
    ...
    <div class="tab-content">
        ...
        <div id="<?= $language?>" class="tab-pane  in <?= ($i==0)?'active':'fade'?>">
            ...
            <?= $form->field($model, 'translate_title['.$language.']')->textInput(['maxlength' => true])->label(Yii::t('yii', 'title_uz', null, $language)) ?>
        </div>
        <?php $j++; }?>
    </div>
